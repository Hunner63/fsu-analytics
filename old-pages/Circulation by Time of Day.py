...
if filtered_df.empty:
    ...
    if comb_data.empty:
        ...
        ax.bar(r1, comb_data['start_counts'], color='b', width=bar_width, label='Scheduled checkout times', text_auto=True)
        ax.bar(r2, comb_data['end_counts'], color='r', width=bar_width, label='Scheduled return times', text_auto=True)
        ax.bar(r3, comb_data['actual_counts'], color='g', width=bar_width, label='Actual return time', text_auto=True)
